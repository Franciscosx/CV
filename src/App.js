        ...
        <section id="contact" className="py-16 bg-zinc-800">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex justify-center items-center gap-8">
              ...
              <div className="w-1/3 bg-zinc-400 text-zinc-800 hover:bg-zinc-300  p-3 rounded-lg">franciscojimnz@gmail.com</div>
              <div className="w-1/3 bg-zinc-400 text-zinc-800 hover:bg-zinc-300  p-3 rounded-lg">franciscojavier641@hotmail.com</div>
